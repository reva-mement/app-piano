...
// 【モード切り替え】 'browsing', 'marble', 'snow', 'flowing' からランダムに選択
// （★ デバッグ用に 'flowing' 固定だったのを、毎回ランダムに変更）
const AVAILABLE_MODES = ['browsing', 'marble', 'snow', 'flowing'];
const MODE = AVAILABLE_MODES[Math.floor(Math.random() * AVAILABLE_MODES.length)];
console.log(`🎨 Session Effect Mode: ${MODE}`);
